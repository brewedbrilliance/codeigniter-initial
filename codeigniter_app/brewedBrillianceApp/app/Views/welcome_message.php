...
<section>
    ...
    <p>
        ...
        DB connection correctly established
        <?php else: ?>
        Unable to connect
        <?php endif; ?>
    </p>
    
    <p>The page you are looking it was generated by CodeIgniter, we changed to reflect our needs </p>
    <p><a href="https://brewedbrilliance.net" target="_blank">BrewedBrilliance - CodeIgniter bootstrap app on Docker</a> </p>
